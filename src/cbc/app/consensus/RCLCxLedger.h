...
#ifndef cbc_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
#define cbc_APP_CONSENSUS_RCLCXLEDGER_H_INCLUDED
...
public:
    ...
    */
    ...
    closeAgree() const
    {
        return cbc::getCloseAgree(ledger_->info());
    }
