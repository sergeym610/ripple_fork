...
#ifndef cbc_APP_MISC_NETWORKOPS_H_INCLUDED
#define cbc_APP_MISC_NETWORKOPS_H_INCLUDED
...
/** Provides server functionality for clients.
    ...
    cbcd / NetworkOPs. However, client software connecting to non-local
    instances of cbcd will need to be hardened to protect against hostile
