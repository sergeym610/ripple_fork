...
#ifndef cbc_PROTOCOL_LEDGERFORMATS_H_INCLUDED
#define cbc_PROTOCOL_LEDGERFORMATS_H_INCLUDED

#include <cbc/protocol/KnownFormats.h>
...
enum LedgerSpecificFlags
{
    ...
    lsfNoFreeze         = 0x00200000,   // True, cannot freeze cbc states
    lsfGlobalFreeze     = 0x00400000,   // True, all assets frozen
    lsfDefaultcbc    = 0x00800000,   // True, trust lines allow rippling by default
    ...
    lsfLowNocbc      = 0x00100000,
    lsfHighNocbc     = 0x00200000,
