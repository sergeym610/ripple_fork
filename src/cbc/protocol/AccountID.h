...
#ifndef cbc_PROTOCOL_ACCOUNTID_H_INCLUDED
#define cbc_PROTOCOL_ACCOUNTID_H_INCLUDED
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, cbcd should
...
public:
    ...
    /** Return cbc::toBase58 for the AccountID
...
template <>
struct hash <cbc::AccountID> : cbc::AccountID::hasher
{
};
