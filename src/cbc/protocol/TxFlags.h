...
#ifndef cbc_PROTOCOL_TXFLAGS_H_INCLUDED
#define cbc_PROTOCOL_TXFLAGS_H_INCLUDED
...
const std::uint32_t asfDefaultcbc       = 8;
...
// Payment flags:
const std::uint32_t tfNocbcDirect       = 0x00010000;
const std::uint32_t tfPartialPayment       = 0x00020000;
const std::uint32_t tfLimitQuality         = 0x00040000;
const std::uint32_t tfPaymentMask          = ~ (tfUniversal | tfPartialPayment | tfLimitQuality | tfNocbcDirect);

// TrustSet flags:
const std::uint32_t tfSetfAuth             = 0x00010000;
const std::uint32_t tfSetNocbc          = 0x00020000;
const std::uint32_t tfClearNocbc        = 0x00040000;
const std::uint32_t tfSetFreeze            = 0x00100000;
const std::uint32_t tfClearFreeze          = 0x00200000;
const std::uint32_t tfTrustSetMask         = ~ (tfUniversal | tfSetfAuth | tfSetNocbc | tfClearNocbc
