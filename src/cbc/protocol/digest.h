...
#ifndef cbc_PROTOCOL_DIGEST_H_INCLUDED
#define cbc_PROTOCOL_DIGEST_H_INCLUDED

#include <cbc/basics/base_uint.h>
#include <cbc/beast/crypto/ripemd.h>
#include <cbc/beast/crypto/sha2.h>
...
/*  Message digest functions used in the cbc Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a cbc account, from a message. Typically the
