...
#ifndef cbc_PROTOCOL_JSONFIELDS_H_INCLUDED
#define cbc_PROTOCOL_JSONFIELDS_H_INCLUDED
...
JSS ( alternatives );               // out: PathRequest, cbcPathFind
...
JSS ( destination_account );        // in: PathRequest, cbcPathFind, account_lines
                                    // out: AccountChannels
JSS ( destination_amount );         // in: PathRequest, cbcPathFind
JSS ( destination_currencies );     // in: PathRequest, cbcPathFind
...
JSS ( issuer );                     // in: cbcPathFind, Subscribe,
...
JSS ( no_cbc );                  // out: AccountLines
JSS ( no_cbc_peer );             // out: AccountLines
...
JSS ( paths );                      // in: cbcPathFind
JSS ( paths_canonical );            // out: cbcPathFind
JSS ( paths_computed );             // out: PathRequest, cbcPathFind
...
JSS ( result );                     // RPC
JSS ( cbc_lines );               // out: NetworkOPs
JSS ( cbc_state );               // in: LedgerEntr
JSS ( cbcrpc );                  // cbc RPC version
JSS ( role );                       // out: Ping.cpp
JSS ( rt_accounts );                // in: Subscribe, Unsubscribe
JSS ( sanity );                     // out: PeerImp
JSS ( search_depth );               // in: cbcPathFind
...
JSS ( send_max );                   // in: PathRequest, cbcPathFind
...
JSS ( source_account );             // in: PathRequest, cbcPathFind
JSS ( source_amount );              // in: PathRequest, cbcPathFind
JSS ( source_currencies );          // in: PathRequest, cbcPathFind
