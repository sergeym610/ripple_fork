...
#ifndef cbc_PROTOCOL_BOOK_H_INCLUDED
#define cbc_PROTOCOL_BOOK_H_INCLUDED
...
template <>
struct hash <cbc::Issue>
    : private boost::base_from_member <std::hash <cbc::Currency>, 0>
    , private boost::base_from_member <std::hash <cbc::AccountID>, 1>
{
private:
    using currency_hash_type = boost::base_from_member <
        std::hash <cbc::Currency>, 0>;
    using issuer_hash_type = boost::base_from_member <
        std::hash <cbc::AccountID>, 1>;

public:
    using value_type = std::size_t;
    using argument_type = cbc::Issue;
...
template <>
struct hash <cbc::Book>
{
private:
    using hasher = std::hash <cbc::Issue>;

    hasher m_hasher;

public:
    using value_type = std::size_t;
    using argument_type = cbc::Book;
