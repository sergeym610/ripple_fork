...
#ifndef cbc_PROTOCOL_UINTTYPES_H_INCLUDED
#define cbc_PROTOCOL_UINTTYPES_H_INCLUDED
...
template <>
struct hash <cbc::Currency> : cbc::Currency::hasher
{
};

template <>
struct hash <cbc::NodeID> : cbc::NodeID::hasher
{
};

template <>
struct hash <cbc::Directory> : cbc::Directory::hasher
{
};
