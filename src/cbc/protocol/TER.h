...
#ifndef cbc_PROTOCOL_TER_H_INCLUDED
#define cbc_PROTOCOL_TER_H_INCLUDED
...
// See https://cbc.com/wiki/Transaction_errors
//
...
enum TER
{
    ...
    terNO_cbc,        // Rippling not allowed
    ...
    // 100 .. 159 C
    //   Claim fee only (cbc transaction with no good paths, pay to
