...
#ifndef cbc_PROTOCOL_PUBLICKEY_H_INCLUDED
#define cbc_PROTOCOL_PUBLICKEY_H_INCLUDED

#include <cbc/basics/Slice.h>
#include <cbc/crypto/KeyType.h> // move to protocol/
...
/** A public key.
    ...
    The format of the public key is cbc specific,
