...
values associated with the cbc protocol.

## Serialized Objects

In cbc objects transmitted over the network must be
serialized into a canonical format. The prefix "ST" refers
to classes that deal with the serialized format of cbc
objects.
...
([Real example](https://github.com/cbc/cbcd/blob/35f4698aed5dce02f771b34cfbb690495cb5efcc/src/cbc/app/tx/impl/PayChan.cpp#L229-L236))
