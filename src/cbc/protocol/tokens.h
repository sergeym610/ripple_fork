...
#ifndef cbc_PROTOCOL_TOKENS_H_INCLUDED
#define cbc_PROTOCOL_TOKENS_H_INCLUDED
...
// Facilities for converting cbc tokens
// to and from their human readable strings

/*  Base-58 encode a cbc Token

    cbc Tokens have a one-byte prefx indicating
