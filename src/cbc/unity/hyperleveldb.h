...
#ifndef cbc_UNITY_HYPERLEVELDB_H_INCLUDED
#define cbc_UNITY_HYPERLEVELDB_H_INCLUDED

#include <beast/Config.h>

#if ! BEAST_WIN32

#define cbc_HYPERLEVELDB_AVAILABLE 1
...
#define cbc_HYPERLEVELDB_AVAILABLE 0
