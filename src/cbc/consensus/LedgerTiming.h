...
#ifndef cbc_APP_LEDGER_LEDGERTIMING_H_INCLUDED
#define cbc_APP_LEDGER_LEDGERTIMING_H_INCLUDED
...
/** Calculates the close time resolution for the specified ledger.
    ...
    The cbc protocol uses binning to represent time intervals using only one
