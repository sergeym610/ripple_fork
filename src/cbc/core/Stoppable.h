...
#ifndef cbc_CORE_STOPPABLE_H_INCLUDED
#define cbc_CORE_STOPPABLE_H_INCLUDED

#include <cbc/beast/core/LockFreeStack.h>
#include <cbc/beast/utility/Journal.h>
#include <cbc/beast/core/WaitableEvent.h>
#include <cbc/core/Job.h>
#include <cbc/core/ClosureCounter.h>
#include <atomic>
#include <chrono>
...
/** Provides an interface for starting and stopping.
    ...
    The form of the Stoppable tree in the cbcd application evolves as
