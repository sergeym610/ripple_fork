...
#ifndef cbc_CORE_CONFIG_H_INCLUDED
#define cbc_CORE_CONFIG_H_INCLUDED

#include <cbc/basics/BasicConfig.h>
#include <cbc/basics/base_uint.h>
#include <cbc/protocol/SystemParameters.h> // VFALCO Breaks levelization
...
public:
    ...
    std::vector<std::string>    IPS;                    // Peer IPs from cbcd.cfg.
    std::vector<std::string>    IPS_FIXED;              // Fixed Peer IPs from cbcd.cfg.
    std::vector<std::string>    SNTP_SERVERS;           // SNTP servers from cbcd.cfg.
