...
#ifndef cbc_BASICS_BASE_UINT_H_INCLUDED
#define cbc_BASICS_BASE_UINT_H_INCLUDED

#include <cbc/basics/ByteOrder.h>
#include <cbc/basics/Blob.h>
#include <cbc/basics/strHex.h>
#include <cbc/basics/hardened_hash.h>
#include <cbc/beast/utility/Zero.h>
...
template <std::size_t Bits, class Tag>
struct is_uniquely_represented<cbc::base_uint<Bits, Tag>>
