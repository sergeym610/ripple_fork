...
#ifndef cbc_BASICS_RANDOM_H_INCLUDED
#define cbc_BASICS_RANDOM_H_INCLUDED
...
static_assert (
    ...
    std::is_unsigned <beast::xor_shift_engine::result_type>::value,
        "The cbc default PRNG engine must return an unsigned integral type.");

static_assert (
    std::numeric_limits<beast::xor_shift_engine::result_type>::max() >=
    std::numeric_limits<std::uint64_t>::max(),
        "The cbc default PRNG engine return must be at least 64 bits wide.");
#endif
...
#endif // cbc_BASICS_RANDOM_H_INCLUDED
