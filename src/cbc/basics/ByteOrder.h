...
#ifndef cbc_BASICS_BYTEORDER_H_INCLUDED
#define cbc_BASICS_BYTEORDER_H_INCLUDED
...
// VFALCO These are all deprecated please use the ones in <cbc/beast/core/ByteOrder.h>
