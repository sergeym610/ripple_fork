...
The _cbc payment network_ consists of a collection of _peers_ running the
**cbcd software**. Each peer maintains multiple outgoing connections and
...
**cbcd** is launched, the existing Bootcache database data is accessed and
...
outgoing connections to foreign peers. This security feature helps cbcd
