...
#ifndef cbc_LEDGER_READVIEW_H_INCLUDED
#define cbc_LEDGER_READVIEW_H_INCLUDED

#include <cbc/ledger/detail/ReadViewFwdRange.h>
...
#include <cbc/ledger/detail/ReadViewFwdRange.ipp>
