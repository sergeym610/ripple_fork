...
#ifndef cbc_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define cbc_ASSETS_ENABLE_STD_HASH 0
# else
#  define cbc_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
BEAST_DEFINE_TESTSUITE(Issue,protocol,cbc);
