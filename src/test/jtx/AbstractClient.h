...
#ifndef cbc_TEST_ABSTRACTCLIENT_H_INCLUDED
#define cbc_TEST_ABSTRACTCLIENT_H_INCLUDED
...
/* Abstract cbc Client interface.

   This abstracts the transport layer, allowing
   commands to be submitted to a cbcd server.
*/
