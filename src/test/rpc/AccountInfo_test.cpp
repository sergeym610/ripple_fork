...
#include <cbc/protocol/JsonFields.h>     // jss:: definitions
   ...
   void testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(info.isMember(jss::cbcrpc) && info[jss::cbcrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(info[0u].isMember(jss::cbcrpc) && info[0u][jss::cbcrpc] == "2.0");
            ...
            BEAST_EXPECT(info[1u].isMember(jss::cbcrpc) && info[1u][jss::cbcrpc] == "2.0");
...
BEAST_DEFINE_TESTSUITE(AccountInfo,app,cbc);
