...
BEAST_DEFINE_TESTSUITE_MANUAL(PlumpBook,tx,cbc);
...
BEAST_DEFINE_TESTSUITE(ThinBook, tx, cbc);
...
BEAST_DEFINE_TESTSUITE_MANUAL(OversizeMeta,tx,cbc);
...
BEAST_DEFINE_TESTSUITE_MANUAL(FindOversizeCross,tx,cbc);
