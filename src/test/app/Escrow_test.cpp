...
struct Escrow_test : public beast::unit_test::suite
{
    ...
    testMetaAndOwnership()
    {
...

        {
            ...
            {
                cbc::Dir bod(*env.current(), keylet::ownerDir(bruce.id()));
...
BEAST_DEFINE_TESTSUITE(Escrow,app,cbc);
