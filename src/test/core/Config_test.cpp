...
{
    static boost::format configContentsTemplate (R"cbcConfig(
[server]
port_rpc
port_peer
port_wss_admin
...
# This is primary persistent datastore for cbcd.  This includes transaction
# metadata, account states, and ledger headers.  Helpful information can be
# found here: https://cbc.com/wiki/NodeBackEnd
# delete old ledgers while maintaining at least 2000. Do not require an
# external administrative command to initiate deletion.
[node_db]
type=memory
path=/Users/dummy/cbc/config/db/rocksdb
open_files=2000
filter_bits=12
cache_mb=256
file_size_mb=8
...
[debug_logfile]
/Users/dummy/cbc/config/log/debug.log
...
# Where to find some other servers speaking the cbc protocol.
#
[ips]
r.cbc.com 51235
...
/**
   Write a cbcd config file and remove when done.
 */
class cbcdCfgGuard : public ConfigGuard
{
private:
    path configFile_;
    path dataDir_;
...
public:
    cbcdCfgGuard (beast::unit_test::suite& test,
    ...
    ~cbcdCfgGuard ()
    {
        ...
        {
            // if we throw here, just let it die.
            test_.log << "Error in ~cbcdCfgGuard: "
                      << e.what () << std::endl;
        };
    }
};
...
{
    std::string configContents (R"cbcConfig(
[validators]
...
recommendedcbcvalidators.com
morecbcvalidators.net
...
0
    ...
    void testDbPath ()
    {
        ...
        }
        {
            ...
            detail::cbcdCfgGuard const g (*this, g0.subdir(),
                dataDirAbs, "", false);
        ...
        }
        {
            ...
            detail::cbcdCfgGuard const g (*this, "test_db", dbPath, "");
            auto const& c (g.config ());
        ...
        }
        {
            ...
            detail::cbcdCfgGuard const g (*this, "test_db", "", "");
            auto const& c (g.config ());
    ...
    void testValidatorKeys ()
    {
        ...
        {
            Config c;
            static boost::format configTemplate (R"cbcConfig(
[validation_seed]
%1%
...
trustthesevalidators.gov
        ...
        }
        {
            ...
            detail::ValidatorsTxtGuard const vtg (
                *this, "test_cfg", "validators.txt");
            detail::cbcdCfgGuard const rcg (*this, vtg.subdir (),
                "", "", false);
            BEAST_EXPECT(vtg.validatorsFileExists ());
            BEAST_EXPECT(rcg.configFileExists ());
            auto const& c (rcg.config ());
...
021A99A537FDEBC34E4FCA03B39BEADD04299BB19E85097EC92B15A3518801E566
        ...
        }
        {
            ...
            // [validator_list_keys] are missing from cbcd cfg and
            // validators file
            Config c;
            boost::format cc ("[validators_file]\n%1%\n");
            std::string error;
    ...
    {
        detail::cbcdCfgGuard const cfg(*this, "testSetup",
...
BEAST_DEFINE_TESTSUITE (Config, core, cbc);
